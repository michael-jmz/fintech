...
import { ProductoActivoComponent } from './pages/banca-minorista/producto-activo/producto-activo.component';
...
@NgModule({
  declarations: [
    ...
    ProfileComponent,
    TimetableComponent,
    BancaMinoristaComponent,
    ProductoPasivoComponent,
    ProductoActivoComponent,
    InversionesComponent,
    AhorrosComponent,
    ServiciosBancariosComponent,
    DiagramasComponent,
    CasosUsoComponent,
